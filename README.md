...
### Бонус :)
В файле [us.hack](us.hack) ([ru.hack](ru.hack) тоже, для русской раскладки) на третьем уровне определен keypad на левой половине клавиатуры и навигационные (PgUp/PgDown тоже) клавиши на правой половине клавиатуры.  
Расчитано под использование через правый Alt. Доступ к третьему уровню раскладки через Alt настраивается в Gnome Tweak Tool  
```
